---
title: "TraR - Regression - Whole Set"
output:
  html_document:
    df_print: paged
editor_options:
...
all_models_3_3 <- lapply(list.files(pattern = 'TraR.csv'), function(x) models.list.parallel(x, 3, 3, leave.out = leave.out, verbose = F))

names(all_models_3_3) <- list.files(pattern = 'TraR.csv')
...
write.csv(top_models_4_4, 'TraR_top_models_4_4_LO_5.csv')
```


```{r}
model.list <- "TraR_top_models_4_4_LO_5.csv"
out.col = 'output'
what.model = 1
