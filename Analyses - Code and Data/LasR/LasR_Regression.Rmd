...
all_models_3_3 <- lapply(list.files(pattern = 'LasR_above_15.csv'), function(x) models.list.parallel(x, 3, 3, leave.out = leave.out, verbose = F))

names(all_models_3_3) <- list.files(pattern = 'LasR_above_15.csv')
...
write.csv(top_models_4_4, 'LasR_above_15_top_models_4_4_LO_5.csv')
```


```{r}
model.list <- "LasR_above_15_top_models_4_4_LO_5.csv"
out.col = 'output'
what.model = 1
